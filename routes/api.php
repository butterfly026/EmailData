...
Route::post('/payments/getElementsFromOrderNo', [PaymentsController::class, 'sendPaymentEmail'])->name('api.payments.send_payment_email');
Route::post('/payments/checkout', [PaymentsController::class, 'getElementsFromOrderNo'])->name('api.payments.getElementsFromOrderNo');
