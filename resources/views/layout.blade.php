...
<body class="h-full">
    ...
    <div class="min-h-full" id="main-content" style="display: none">
        <!-- loading End -->
        <!-- Header -->
                                    ...
                                    @if (Auth::user())
                                        ...
                                        <li class="nav-item dropdown" style="display: flex; align-items: center;">
                                            <a class=" nav-instant-access nav-link d-inline-block"
                                                style="padding: 5px 30px; font-size: 17px;" href="javascript:void(0)">
                                                <span>
        ...
        @if (Auth::user())
            @if (Auth::user()->is_email_verified || Auth::user()->user_type == 1)
                <main>
